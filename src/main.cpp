...
// Copyright (c) 2013 The YYF developers
...
uint256 hashGenesisBlock("0x00000401d7281535ea7abf9482fa7136ed0b753d6d5f99675068cb4a93291c97");
static const unsigned int timeGenesisBlock = 1456653068;
...
const string strMessageMagic = "YYF Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "already in already CBigNum we YYF from USA with reindexing.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xd46dcba34774fb776dcabf2ab86c1b79443ee44b016682c6f7597ea298823c61"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("YYFMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("YYFMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("YYFMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("YYF-miner");
    ...
    try { loop {
        ...
        printf("Running YYFMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
