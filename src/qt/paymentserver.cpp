...
const QString BITCOIN_IPC_PREFIX("YYF:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click YYF: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start YYF: click-to-pay handler");
    else
...
{
    // clicking on YYF: URLs creates FileOpen events on the Mac:
